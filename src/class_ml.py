...
class ML:
    # this class defines the machine learning functions
    ...
    def show_feature(X, y):
        ...
        print(str(percentage) + "% of all pixels in the image are water. From " + str(sep) + " till " + str(
            till) + ". So " + str(till - sep) + " in total!")
