...
loc_6 = [[12.33, 47.97], [15.56, 47.97], [15.56, 52.8], [12.33, 52.8], [12.33, 47.97]]

img = class_wow_imagery.WowImagery(loc_6)

product_list = img.get_product_list_for_merging('15_08_2015')
